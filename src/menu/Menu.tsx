    ...
    <nav>
      <ul id="menuUl">
        <div className='liDiv' id="menuHome" onClick={() => props.updatePage("home")}>
            ...
            { props.page === "home" ? <img className="arrowImg" src='src\images\arrowRight.png'/> : <div className="arrowImg"/> }
        </div>
        <div className='liDiv' id="menuInterests" onClick={() => props.updatePage("interests")}>
            <li className="menuLi">Om mig</li>
            { props.page === "interests" ? <img className="arrowImg" src='src\images\arrowRight.png'/> : <div className="arrowImg"/> }
        </div>
        <div className='liDiv' id="menuPortfolio" onClick={() => props.updatePage("portfolio")}>
            <li className="menuLi">Portfolio</li>
            { props.page === "portfolio" ? <img className="arrowImg" src='src\images\arrowRight.png'/> : <div className="arrowImg"/> }
        </div>
        <div className='liDiv' id="menuExperience" onClick={() => props.updatePage("experience")}>
            <li className="menuLi">Erfarenhet</li>
            { props.page === "experience" ? <img className="arrowImg" src='src\images\arrowRight.png'/> : <div className="arrowImg"/> }
        </div>
        <div className='liDiv' id="menuContact" onClick={() => props.updatePage("contact")}>
            <li className="menuLi">Kontakt</li>
            { props.page === "contact" ? <img className="arrowImg" src='src\images\arrowRight.png'/> : <div className="arrowImg"/> }
        </div>
      </ul>
    </nav>
  )
