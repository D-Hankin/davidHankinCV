  ...
  return (
    <div id="contentContact">
      <table id="contactTable">
        <tbody>
            <tr>
              <td><img className="contactIcons" src={ phone } /></td>
