        ...
        <table className="experienceTable">
          ...
          <tr>
              ...
              <td>
                  ...
                  <p>Ansvar för paketterminalens produktion dagligen men även långsiktig med tanke på stora projekt och händelse. Ansvar för sex arbetsledare.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                  ...
                  <p>Mer fokus på företagets logistiska processer. Ansvar för planering och tillsyn av ankomst och avgång av gods från terminalen. Kontakt med företagskunder 
                    för att planera ankomster eller lösa logistiska problem. Säkerhetsansvar med fokus på förare, arbetsplats och logistiska frågor.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                  ...
                  <p>Planering och genomförande av den dagliga produktionen på paketterminalen med fokus på personal men även överblick över de logistiska processerna.
                    Ansvarig för ett 70-tal arbetare dagligen tillsammans med fyra andra.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                  ...
                  <p>Mitt första jobb efter flytten till Sverige. Mycket fysiskt arbete där man lossade och lastade släp.</p>
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <tr>
            ...
            <tr>
              ...
              <td>
                  ...
                  <p>En tvåårig kurs studerad i 50% takt samtidigt som jag arbetade heltid.
                    Avancerad matematik och fysik med fokus på astrofysik.
                    Det slutliga projektet var att fastställa ljuskällan för ett oidentifierat pulserande himlaobjekt med fjärråtkomst till ett teleskop i Tyskland.</p>
              </td>
            </tr>
          </tbody>
        </table>
